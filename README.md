...
| [mediatek-bluetooth-firmware](firmware/mediatek-bluetooth-firmware) | :white_large_square: contrib | [ghcr.io/siderolabs/mediatek-bluetooth-firmware](https://github.com/siderolabs/extensions/pkgs/container/mediatek-bluetooth-firmware) | `20260810` |  This system extension provides the MediaTek MT7922 Bluetooth firmware binary from the pinned Sidero Labs linux-firmware package. |
