...
| [bluetooth-usb-drivers](drivers/bluetooth-usb-drivers) | :white_large_square: contrib | [ghcr.io/siderolabs/bluetooth-usb-drivers](https://github.com/siderolabs/extensions/pkgs/container/bluetooth-usb-drivers) | `VERSION` |  This system extension provides the Linux Bluetooth core, USB HCI, and vendor helper kernel modules built against a specific Talos version. Firmware and Bluetooth userspace are intentionally not included. |
