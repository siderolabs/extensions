...
| [cachefilesd](storage/cachefilesd) | :white_large_square: contrib | [ghcr.io/siderolabs/cachefilesd](https://github.com/siderolabs/extensions/pkgs/container/cachefilesd) | `VERSION` |  This system extension provides cachefilesd (FS-Cache caching backend daemon) and the cachefiles kernel module built against a specific Talos version. |
